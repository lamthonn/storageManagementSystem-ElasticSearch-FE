...
const DanhMucPhongBan = () => {
  ...
  useEffect(() => {
    getPerms(routesConfig.danhMucPhongBan)
      .then((res: any) => {
        setPerms(res.data);
      })
      .catch((err: any) => {
  ...
  const handleDeleteConfirm = async (record: any) => {
    await deletePhongBan(record.id)
      .then((response: any) => {
        ShowToast("success", "Thông báo", "Xóa phòng ban thành công", 3);
        setIsRefreshData(!isRefreshData);
      })
      .catch((error: any) => {
        ShowToast("error", "Thông báo", "Xóa phòng ban thất bại", 3);
      });
  };
  ...
  const handleAdd = async () => {
    ...
    await createPhongBan(data)
      .then((response: any) => {
        ShowToast("success", "Thông báo", "Thêm phòng ban thành công", 3);
      ...
      .catch((error: any) => {
        if (error.response.data) {
          ...
          ShowToast("error", "Thông báo", "Thêm phòng ban thất bại", 3);
        }
      });
  };
  ...
  const handleEdit = async () => {
    ...
    await updatePhongBan(id, data)
      .then((response: any) => {
        ShowToast("success", "Thông báo", "Cập nhật phòng ban thành công", 3);
        setIsOpenModalEdit(false);
        formEdit.resetFields();
        setIsRefreshData(!isRefreshData);
      })
      .catch((error: any) => {
        ShowToast("error", "Thông báo", "Cập nhật phòng ban thất bại", 3);
      });
  };
  ...
  return (
    <div>
      ...
      <div className="action-buttons">
        ...
        <div>
          ...
          <Modal
            ...
            footer={null}
          >
            <p>Bạn có chắc chắn muốn xóa các phòng ban đã chọn không?</p>
      ...
      <TableComponent
        ...
        columns={column}
        src="api/danh-muc-phong-ban/get-all"
        request={{
          keySearch: tenDM,
...
export default DanhMucPhongBan;
